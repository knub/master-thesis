...
\title{Comparing Topic Models and Word Embeddings}
...
To summarize, we will start with experiments to work out the differences between topic models and word embeddings.
Afterwards, we will try two approaches in parallel.
