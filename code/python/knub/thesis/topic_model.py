...
def main():
    ...
    print mm
    # lda = gensim.models.ldamulticore.LdaMulticore(corpus=mm, num_topics=100, id2word=id2word, chunksize=10000, passes=1)
    lda = gensim.models.ldamulticore.LdaMulticore(corpus=mm, num_topics=100, id2word=id2word, workers=3)
