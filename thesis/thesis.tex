...
\section{Evaluation data sets}


We removed everything before the abstract except the title


For both corpora, we lowercased, removed stopwords.
We also removed words, which did not occur in the embedding models.
...
\begin{table}[]
  ...
  \begin{tabular}{@{}lp{4cm}cc@{}}
    \toprule
                 ...
                 % TODO: Adapt WELDA to  take best lambda
  \end{tabular}
\end{table}
