...
\end{enumerate}
% TODO: Show example best/worst topics using C_V?
...
\section{Evaluating Topic Coherence}




In this thesis, we follow the work by Röder et al.~\cite{Roder2015}.
Their evaluation workflow worked as follows:
They used human topic rankings provided by XXX.
The human annotators were asked to rate topic words.
