...
\begin{table}[]
  \ra{1.3}
  \centering
  \caption{Comparison of WELDA's topic coherence when implemented using von Mises-Fisher (vMF) distributions and Gaussian mixtures (GM) instead of Gaussian distributions.
  Experiments were run on the \textsc{20News} corpus.
  on \textsc{20News}. The $\Delta TC$ columns indicate the difference. A negative value indicates that von Mises-Fisher distributions perform worse.}
