...
\begin{figure}
       ...
       \caption{Final topic coherence values for different values of $N_{pca}$ and $N_{top}$. We also plotted a regression line indicating the development for increasing $N_{top}$. $N_{top}$ does not have a huge influence on the topic coherence. In contrast, the higher $N_{pca}$ the better the topic coherence.}
...
\begin{table}[]
  ...
  \begin{tabular}{@{}ccccccc@{}}
    \toprule
           ...
           $\lambda$ & $\lambda_{act}$ & $TC~vMF$        & $TC~GM$ &           & $TC~vMF$         & $\Delta TC$      \\
           \midrule
           0.2       & 0.29            & 45.8 $\pm 0.0$  &      && 46.1       & $+1.1$           \\
           0.4       & 0.47            & 45.3 $-1.8$     &      && 45.9       & $+0.3$           \\
           0.5       & 0.56            & 45.6 $-1.1$     &      && 46.0       & $+0.5$           \\
           0.6       & 0.64            & 45.1 $-0.4$     &      && 45.6       & $+0.8$           \\
...
\begin{table}[]
  ...
  \begin{tabular}{@{}lp{4cm}cc@{}}
    \toprule
                 ...
                 WELDA Gaussian, $\lambda = 0.5$ & ~~~~~~~~~~~~~~~~\xmark                        & 67 min          & \\ \bottomrule % 4027 sec,
                 WELDA vMF, $\lambda = 0.5$ & ~~~~~~~~~~~~~~~~\xmark                             & 101 min          & \\ \bottomrule
  \end{tabular}
\end{table}
