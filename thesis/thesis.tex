...
In this master thesis, we proposed WELDA

handle polysemous words
by setting priors on the topic distributions 
Our topic distributions are currently estimated from the data.
By setting priors on the distributions  one could set a prior on the types of topics we want.
