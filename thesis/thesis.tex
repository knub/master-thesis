...
For embedding models, we took the cosine similarity between the two vectors.
...
Before running running the Gibbs sampling, we load a word embedding model (line 2).
