...
Indeed, in Gaussian distributions the similarity between samples is estimated by Euclidean distance.
...
Because of that, they instead propose the von Mises-Fisher distribution to capture topics in the embedding space, which relies on the cosine similarity.
...
% For example, the topic words TODO make out only x percent of the words in the documents, where this topic is the dominating one.
