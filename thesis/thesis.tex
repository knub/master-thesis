...
\begin{table}[]
  ...
  \begin{tabular}{@{}lp{4cm}rr@{}}
    \toprule
                                        & Parallel implementation \newline available      & \multicolumn{1}{c}{\textsc{20News}} & \multicolumn{1}{c}{\textsc{Nips}}       \\ \midrule
                 LDA                    & ~~~~~~~~~~~~~~~~\cmark                                 & 6 min         & 9 min \\ % 378 seconds, 527 seconds
                 LFTM, $\lambda = 0.6$  & ~~~~~~~~~~~~~~~~\xmark                                 & 3672 min          & 71 min \\
                 TopicVec               & ~~~~~~~~~~~~~~~~\cmark                                 & 178 min         & \\
                 Gaussian LDA           & ~~~~~~~~~~~~~~~~\xmark                                 & 846 min          & \\ % 50713 seconds
...
\begin{appendices}
  ...
  \subsection{Influence of parameters $N_{pca}$ and $N_{top}$ on the N{\footnotesize IPS} corpus}
