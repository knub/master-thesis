...
%%% Option 1:
\usepackage[backend=bibtex, bibstyle=numeric, citestyle=numeric, sorting=nty, maxnames=9, doi=false, isbn=false, eprint=false]{biblatex}
%%% Option 2:
...
We ran additional experiments with $N_{pca} = 50$ and $N_{top} = 200$ to test how the distributions performance changes with a higher dimensionality of the word embeddings.
...
% fewer: dimensions: slower runtime, losing information; more dimensions, usually only one cluster because of CoD
  ...
  \begin{table}[H]
    ...
    \begin{tabular}{lrrrcrrr}
      ...
      \multirow{2}{*}{} & \multicolumn{3}{c}{$K = 50$} & \phantom{a} & \multicolumn{3}{c}{$K = 250$} \\ \cmidrule{2-4} \cmidrule{6-8}
                        ...
                        WELDA $\lambda_{act} = 0.4$      & 61.3    & 60.9    & 60.8   && 65.6    & 63.7     & 63.9   \\ % lambda = 0.3
