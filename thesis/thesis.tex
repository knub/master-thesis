...
\begin{table}[]
  ...
  \begin{tabular}{lrrrcrrr}
    ...
    \multirow{2}{*}{} & \multicolumn{3}{c}{$K = 50$} & \phantom{a} & \multicolumn{3}{c}{$K = 250$} \\ \cmidrule{2-4} \cmidrule{6-8}
                      ...
                      Only Avg. Emb.           & 71.5    & 70.4    & 69.9   && \multicolumn{3}{l}{}        \\
                      LDA                      & 69.7    & 67.7    & 66.9   && 72.5    & 71.9     & 71.7   \\
                      LDA + Avg. Emb.          & 76.5    & 76.2    & 77.0   && 77.9    & 77.4     & 77.3   \\
                      LFTM                     & 69.0    & 67.7    & 66.5   && 71.4    & 71.0     & 70.8   \\
                      LFTM + Avg. Emb.         & 69.0    & 67.7    & 66.5   && 71.4    & 71.0     & 70.8   \\
                      TopicVec                 & 34.7    & 34.4    & 31.4   && 40.9    & 37.3     & 33.7   \\
                      TopicVec + Avg. Emb.     & 34.7    & 34.4    & 31.4   && 40.9    & 37.3     & 33.7   \\
                      Gaussian LDA             & 41.6    & 43.4    & 40.5   && 0.xx    & 0.xx     & 0.xx   \\
                      Gaussian LDA + Avg. Emb. & 41.6    & 43.4    & 40.5   && 0.xx    & 0.xx     & 0.xx   \\
                      WELDA                    & 0.62    & 0.57    & 0.57   && 0.68    & 0.66     & 0.66   \\
                      WELDA + Avg. Emb.        & 0.62    & 0.57    & 0.57   && 0.68    & 0.66     & 0.66   \\
  \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[]
  ...
  \begin{tabular}{lrrrcrrr}
    ...
    \multirow{2}{*}{} & \multicolumn{3}{c}{$K = 50$} & \phantom{a} & \multicolumn{3}{c}{$K = 250$} \\ \cmidrule{2-4} \cmidrule{6-8}
                      ...
                      LDA                      & 69.7    & 67.7    & 66.9   && 72.5    & 71.9     & 71.7   \\
                      LDA + Avg. Emb.          & 79.1    & 78.6    & 78.6   && xxxx    & xxxx     & xxxx   \\
                      LFTM                     & xxxx    & xxxx    & xxxx   && xxxx    & xxxx     & xxxx   \\
                      LFTM + Avg. Emb.         & xxxx    & xxxx    & xxxx   && xxxx    & xxxx     & xxxx   \\
                      TopicVec                 & xxxx    & xxxx    & xxxx   && xxxx    & xxxx     & xxxx   \\
                      TopicVec + Avg. Emb.     & xxxx    & xxxx    & xxxx   && xxxx    & xxxx     & xxxx   \\
                      Gaussian LDA             & xxxx    & xxxx    & xxxx   && xxxx    & xxxx     & xxxx   \\
                      Gaussian LDA + Avg. Emb. & xxxx    & xxxx    & xxxx   && xxxx    & xxxx     & xxxx   \\
                      WELDA                    & xxxx    & xxxx    & xxxx   && xxxx    & xxxx     & xxxx   \\
                      WELDA + Avg. Emb.        & xxxx    & xxxx    & xxxx   && xxxx    & xxxx     & xxxx   \\
  \bottomrule
  \end{tabular}
\end{table}
