...
In embedding models, we take the cosine similarity between the two vectors.
...
Surprisingly, 
As a summary, syntactic variations and more direct connectedness play a bigger role in word embedding models, while topic models often capture loose relationships.
We take this as motivation to create topic models, whose topics 
to strengthen the topic themes 
