...
The second term corresponds to the means of each Gaussian.
...
However, this goes against the main idea of WELDA, i.e. resampling similar words from the topic space.

\subsection{Implementation}

Our WELDA implementation is written in Scala.
For loading the word vectors, we use the the Deeplearning4j\footnote{https://deeplearning4j.org/} library.
