...
This helps replace generic words, while at the same time removing overly general words.
...
Topic coherence is a standard task to evaluate topic models.
...
Stop word removal, lowercase, build matrix, stemming
Train mallet
Visualize in tsne
