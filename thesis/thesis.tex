...
Zero corresponds to the highest similarity because in thise case the probability distributions are identical.
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}lp{4cm}rr@{}}
    ...
    WELDA Gaussian, $\lambda = 0.5$ & ~~~~~~~~~~~~~~~~\xmark                     &   67 min                            &   49 min \\  % 4027 sec,
