...
% Please add the following required packages to your document preamble:
	...
	\multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}l@{}}Topic model\\ similarity\end{tabular}}} & Low       &                           &                            \\
       ...
       % \begin{tabular}{cp{3cm}p{3cm}}
                                              % & \multicolumn{2}{c}{\textbf{Word embedding similarity}} \\
                                              % & Low & High \\
              % \hline
              % Blei et al.~\cite{Blei2003}     & \cmark &
              % \hline
       % \end{tabular}
       \label{table:tm_and_we_word_similarities}
\end{table*}

\section{Self trained word2vecs}
...
\begin{algorithm}
  \caption{Gibbs sampling algorithm for the WELDA model}\label{euclid}
  \begin{algorithmic}[1]
    \Procedure{Init}{}
