...
Two existing approaches in this area are topic models and word embeddings.
...
The contributions of these thesis are:
\begin{itemize}
  \item
    We propose a new topic model called WELDA (Word Embedding LDA).
    WELDA uses the word embeddings to resample new words based on the topic.
  \item
...
\end{itemize}
Open questions:
Should both models be trained on the same corpus?


Contribution:
New topci model
Show corpus-level embeddings are helpful
