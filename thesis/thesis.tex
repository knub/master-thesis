...
In general, the F1 scores are higher for $K = 250$.
...
% TODO: Gaussian LDA 250 add results and text!
...
\begin{table}[]
  ...
  \begin{tabular}{lrrrcrrr}
    ...
    \multirow{2}{*}{} & \multicolumn{3}{c}{$K = 50$} & \phantom{a} & \multicolumn{3}{c}{$K = 250$} \\ \cmidrule{2-4} \cmidrule{6-8}
                      ...
                      Gaussian LDA             & 41.6    & 43.4    & 40.5   && xxxx    & xxxx     & xxxx   \\
                      Gaussian LDA + Avg. Emb. & 72.7    & 72.3    & 71.8   && xxxx    & xxxx     & xxxx   \\
                      WELDA                    & 62.1    & 61.3    & 61.0   && 64.9    & 64.6     & 64.3   \\
...
The observation regarding the number of topics is the same as before: $K = 250$ performs better than $K = 50$ for all models.
...
\begin{table}[]
  ...
  \begin{tabular}{lrrrcrrr}
    ...
    \multirow{2}{*}{} & \multicolumn{3}{c}{$K = 50$} & \phantom{a} & \multicolumn{3}{c}{$K = 250$} \\ \cmidrule{2-4} \cmidrule{6-8}
                      ...
                      WELDA                    & 61.3    & 60.9    & 60.8   && 64.1    & 64.0     & 63.9   \\ % lambda = 0.3
                      WELDA + Avg. Emb.        & 79.2    & 78.6    & 78.3   && 80.1    & 79.6     & 79.4   \\
  \bottomrule
  \end{tabular}
\end{table}
...
Word Embeddings definitely help.
...
\begin{table}[]
  \centering
  \caption{Runtimes of the different methods on the \textsc{20News} and \textsc{Nips} corpus.
  ...
  \begin{tabular}{@{}lp{4cm}cc@{}}
    \toprule
                 ...
                 LDA                    & ~~~~~~~~~~~~~~~~\cmark                                 & xxxxx           & cccccccccc \\
                 LFTM, $\lambda = 0.6$  & ~~~~~~~~~~~~~~~~\xmark                                 &                 & \\
                 TopicVec               & ~~~~~~~~~~~~~~~~\cmark                                 &                 & \\
                 Gaussian LDA           & ~~~~~~~~~~~~~~~~\xmark                                 &                 & \\
                 WELDA                  & ~~~~~~~~~~~~~~~~\xmark                                 &                 & \\ \bottomrule
  \end{tabular}
\end{table}
