...
As seen in Section~\ref{sec:lda_as_baseline} where we evaluated the topic coherence for different $\alpha$ and $\beta$ values, the topic coherence of an LDA model is subject to random fluctuations.
...
Therefore, we now evaluate how much the topic coherence fluctuates for several WELDA runs ev
% TODO: Mention alpha und beta taken from LDA?
Due to the additional sampling from the embedding space,

We therefore evaluated, how big 
