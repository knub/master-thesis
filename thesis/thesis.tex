...
We then randomly resample words from this distribution during the Gibbs sampling inference.
...
For example, when learning topics on the \textsc{20News} corpus, one might be fine with only one topic about \emph{sports}, but wants several fine-grained topics about \emph{politics}.

% Document classification
% Our methods has potential applications in document retrieval, clustering and 
For our work, we assumed fixed pre-trained word embeddings and only focused on improved topic models.
