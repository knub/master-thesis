...
In contrast to topic coherence, this allows using topic models in an supervised setting with clear evaluation metrics.
...
The higher $\lambda$, the more new words are sample, which leads to more nearest-neighbor searches.
...
We also showed that corpus-specific embeddings, albeit lacking quality when evaluating the embeddings alne, can still help to improve topic coherence because they are learned on the same documents.
...
% curse of dimensionality for nearest neighbor search
